    ...
    <el-card class="panel-card" v-if="stats">
      <template #header>
        <div class="panel-title-wrap">
          <strong class="panel-title">热门文章 Top 10</strong>
        </div>
      </template>
      <el-table class="admin-table" :data="stats.topPosts.slice(0, 10)" stripe>
